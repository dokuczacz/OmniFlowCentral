...
TOOL_SPECS = {
    ...
    "query_dataset": {
        "description": "Unified dataset query tool. Search NDJSON indexes with optional full content fetching. For PrawoL: use dataset=eli_acts.",
        "method": "POST",
        "params": {
            "dataset": "string (dataset name; for PrawoL use: eli_acts)",
            ...
            "court": "optional string (dataset-dependent filter by court name)",
            "court_type": "optional string (dataset-dependent filter by court type)",
            "pageId": "optional string (deterministic id; for ELI: DU/2025/1882)",
            "recordIndex": "optional int (deterministic index; for ELI: pos)",
